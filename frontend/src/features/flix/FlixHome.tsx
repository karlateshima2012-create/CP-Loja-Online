...
const ProfilePoster: React.FC<{ profile: FlixProfile }> = ({ profile }) => {
    ...
    return (
        <Link to={`/p/${profile.slug}`} className="block relative group aspect-[2/3] rounded-md overflow-hidden transition-all duration-300 hover:scale-105 hover:z-20 hover:shadow-xl hover:shadow-brand-pink/20 bg-slate-800">
            {displayImage ? (
