            ...
            <section id="catalog-results" className="relative z-20 pb-32 px-4 overflow-hidden min-h-screen pt-24 md:pt-32">
                ...
                <div className="container mx-auto relative z-10">
                    ...
                    <div className="mb-10 text-center animate-fade-in-up">
                        <h1 className="text-xl md:text-3xl font-black text-white uppercase tracking-tight mb-3">
                            Personalização 3D e <span className="text-brand-blue">tecnologia NFC.</span>
                        </h1>
                        <p className="text-slate-500 text-[9px] md:text-xs font-bold uppercase tracking-[0.2em] max-w-2xl mx-auto leading-relaxed">
                            O presente corporativo que une design, e conexão digital.
                        </p>
