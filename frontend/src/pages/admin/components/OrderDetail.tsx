                            ...
                            <table className="w-full text-sm text-left text-slate-400">
                                ...
                                <tbody className="divide-y divide-slate-800">
                                    {order.items.map((item, idx) => {
                                        const partner = item.partnerId || item.referralPartnerId ? mockService.getPartnerById(item.partnerId || item.referralPartnerId || '') : null;
                                        ...
                                        return (
                                            <tr key={idx} className="hover:bg-slate-800/30">
                                                ...
                                                <td className="px-6 py-4">
                                                    ...
                                                    {partner && (
                                                        <div className="mt-2 text-[10px] bg-brand-yellow/10 text-brand-yellow px-2 py-1 rounded border border-brand-yellow/20 inline-flex items-center gap-1">
                                                            <Star size={10} /> Parceiro: {partner.name}
                                                        </div>
                                                    )}
                                                </td>
                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-slate-900 rounded-2xl border border-slate-800 shadow-xl overflow-hidden p-5">
                        ...
                        <button 
                            ...
                            disabled={isSaving}
                            className={`w-full text-white px-4 py-2 rounded-lg font-bold flex items-center justify-center gap-2 shadow-lg transition-all ${
                                saveSuccess 
                                ? 'bg-green-600' 
